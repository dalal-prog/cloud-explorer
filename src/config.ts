...
export const CONFIG = {
  ...
  favorite: {
    ...
    posterUrl:
      "https://static1.srcdn.com/wordpress/wp-content/uploads/2023/05/sherlock-show-poster.jpg",
  },
};
